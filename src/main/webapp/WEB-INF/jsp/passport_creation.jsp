...
<form class="form-horizontal" action="${pageContext.request.contextPath}/bank?command=save_passport_command" method="post" style="padding-bottom: 20px; padding-top: 42px; padding-left: 30px">
    <fieldset>
        <div id="legend">
