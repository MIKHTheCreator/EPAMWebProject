            ...
            <table class="table table-striped custab">
                ...
                <c:forEach items="${sessionScope.creditCards}" var="creditCard">
                    <tr>
                        ...
                        <td class="text-center"><a class='btn btn-info btn-xs' href="${pageContext.request.contextPath}/bank?command=show_make_payment_command"><span class="glyphicon glyphicon-edit"></span>${pay}</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
