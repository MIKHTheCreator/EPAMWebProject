...
import com.epam.jwd.controller.command.impl.DeleteCreditCardCommand;
...
import com.epam.jwd.controller.command.impl.show_page.ShowEditPassportPageCommand;
...
public enum Commands {
    ...
    BLOCK_USERS_BANK_ACCOUNT_COMMAND(BlockUsersBankAccountCommand.getInstance(), Role.ADMIN, Role.USER),
    ...
    DELETE_CREDIT_CARD_COMMAND(DeleteCreditCardCommand.getInstance(), Role.ADMIN);
